...
<div class="cart-items">
	<div class="container">
				...
				while ($row = $result->fetch_assoc())
				{
				 	...
				 	<div class='cart-sec simpleCart_shelfItem'>
					   ...
					   <div class='cart-item-info'>
						<h3>".$row["Name"]."<span>".$row["RID"]."</span></h3>
						<ul class='qty'>
							<li><p>Quantity: ".$row["Quantity"]."</p></li>
							
						</ul>
							 <div class='delivery'>
							 <p>Price: ".$row["price"]."INR</p>
							
							 <div class='clearfix'></div>
				        </div>	
					   </div>
					   <a href = 'PHP/DeleteItem.php?prod=".$row["Name"]."'>
					   <button>Delete Item</button></a>
					   <div class='clearfix'></div>
			...
			else
			{
				...
				<h1 align = 'Center'>0 Items in Cart!</h1>
				<br><br>
				<br><br>
				<br><br>
		 ...
		 <div align = 'Center'>
		 	<a href = "PHP/CreateOrder.php">
		 	<button class="button" style="vertical-align:middle"><span>Submit Order</span></button></a>
		 </div>
		 <br><br>
<!-- checkout -->
